...
internal static partial class LogMessages
{
    ...
    public static partial void CannotAuthenticateSchemeToAcquireUserAccessToken(
        this ILogger logger, Scheme? scheme);
    ...
    public static partial void SendingDPoPProofToken(this ILogger logger, Uri? url);

    [LoggerMessage(
        Level = LogLevel.Debug,
        Message = $"Failed to create DPoP proof token for request to endpoint: {{{OTelParameters.Url}}}")]
    public static partial void FailedToCreateDPopProofToken(this ILogger logger, Uri? url);


    [LoggerMessage(
        Level = LogLevel.Debug,
        Message = $"Sending Access token of type {{{OTelParameters.TokenType}}} to endpoint: {{{OTelParameters.Url}}}.")]
    public static partial void SendAccessTokenToEndpoint(this ILogger logger, Uri? url, string? tokenType);
    ...
    public static void RefreshingAccessTokenUsingRefreshToken(this ILogger logger, RefreshTokenString refreshToken, Func<string, string> hashAlgorithm)
    {
        if (logger.IsEnabled(LogLevel.Trace))
        {
            RefreshingTokenUsingRefreshTokenImplementation(logger, hashAlgorithm(refreshToken.Value));
        }
    }
    ...
    public static partial void SendingRefreshTokenRequest(this ILogger logger, Uri? url);
    ...
    /// <param name="refreshToken"></param>
    /// <param name="hashAlgorithm"></param>
    public static void RevokingRefreshToken(this ILogger logger, RefreshTokenString refreshToken, Func<string, string> hashAlgorithm)
    {
        if (logger.IsEnabled(LogLevel.Trace))
        {
            RevokingRefreshTokenImplementation(logger, hashAlgorithm(refreshToken.Value));
        }
    }
    ...
    public static partial void SendingTokenRevocationRequest(this ILogger logger, Uri url);
    ...
    public static partial void CannotRetrieveAccessTokenDueToNoRefreshTokenFound(this ILogger logger, string user, Resource resource);
    ...
    public static partial void NoAccessTokenFoundWillRefresh(this ILogger logger, string user, Resource resource);
    ...
    public static partial void DebugTokenNeedsRefreshing(this ILogger logger, string user, DateTimeOffset? expiration, ForceTokenRenewal forceRenewal);
    ...
    public static partial void UserAccessTokenRefreshed(this ILogger logger, AccessTokenType? tokenType, DateTimeOffset expiration);
    ...
    public static partial void CachingAccessToken(this ILogger logger, ClientCredentialsClientName clientName, DateTimeOffset expiration);
    ...
    public static partial void WillNotCacheTokenResultWithError(this ILogger logger, ClientCredentialsClientName clientName,
    ...
    public static partial void ExceptionWhileReadingFromCache(this ILogger logger, Exception ex, ClientCredentialsClientName clientName);
    ...
    public static partial void FailedToRequestAccessTokenForClient(this ILogger logger, ClientCredentialsClientName clientName, string? error, string? errorDescription);

    [LoggerMessage(
        Level = LogLevel.Error,
        Message = $"Error trying to set token in cache for client {{{OTelParameters.ClientName}}}")]
    public static partial void ErrorSettingTokenInCache(this ILogger logger, Exception ex, ClientCredentialsClientName clientName);

    [LoggerMessage(
        Level = LogLevel.Debug,
        Message = $"Cache hit for obtaining access token for client: {{{OTelParameters.ClientName}}}")]
    public static partial void CacheHitForObtainingAccessToken(this ILogger logger, ClientCredentialsClientName clientName);

    [LoggerMessage(
        Level = LogLevel.Debug,
        Message = $"Cache hit for DPoP nonce for URL: {{{OTelParameters.Url}}}, method: {{{OTelParameters.Method}}}")]
    public static partial void CacheHitForDPoPNonce(this ILogger logger, Uri url, HttpMethod method);
    ...
    public static partial void WritingNonceToCache(this ILogger logger, Uri url, HttpMethod method, DateTimeOffset expiration);

    [LoggerMessage(
        Level = LogLevel.Debug,
        Message = $"Writing DPoP nonce to Cache for URL: {{{OTelParameters.Url}}}, method: {{{OTelParameters.Method}}}. Expiration: {{{OTelParameters.Expiration}}}")]
    public static partial void WritingNonceToCache(this ILogger logger, Uri url, HttpMethod method, TimeSpan expiration);

    [LoggerMessage(
        Level = LogLevel.Trace,
        Message = $"Cache miss for DPoP nonce for URL: {{{OTelParameters.Url}}}, method: {{{OTelParameters.Method}}}")]
    public static partial void CacheMissForDPoPNonce(this ILogger logger, Uri url, HttpMethod method);
    ...
    public static partial void CachedNonceParseFailure(this ILogger logger, Uri url, HttpMethod method, string value, string error);

    [LoggerMessage(
        Level = LogLevel.Error,
        Message = $"Error parsing cached access token for client {{{OTelParameters.ClientName}}}")]
    public static partial void FailedToCacheAccessToken(this ILogger logger, Exception ex, ClientCredentialsClientName clientName);

    [LoggerMessage(
        Level = LogLevel.Trace,
        Message = $"Cache miss while retrieving access token for client: {{{OTelParameters.ClientName}}}")]
    public static partial void CacheMissWhileRetrievingAccessToken(this ILogger logger, ClientCredentialsClientName clientName);
    ...
    public static partial void RequestingClientCredentialsAccessToken(this ILogger logger, Uri url);
    ...
    public static partial void ClientCredentialsTokenForClientRetrieved(this ILogger logger, ClientCredentialsClientName clientName, AccessTokenType? tokenType, DateTimeOffset expiration);
    ...
    public static partial void FailedToObtainTokenFromCache(this ILogger logger, Exception ex, ClientCredentialsClientName clientName, ClientCredentialsCacheKey cacheKey);
